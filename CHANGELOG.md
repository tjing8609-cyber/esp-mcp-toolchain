...
- 个人 marketplace 源已受控同步为 `0.1.0+codex.20260726165544`；源目录 `104 passed`、plugin validator 和 `48 tools / 12 resources / 12 prompts` 直接枚举通过。安装缓存仍为旧版 `0.1.0+codex.20260722153803`，待用户重启后验收。
